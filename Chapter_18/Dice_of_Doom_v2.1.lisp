...
(defparameter *board-size* 4) ; 3x3 board. This version can handle 3x3 grids easily in clisp, bigger boards needs more optimization. See ver 2.
...
;;; This is imperative because it changes tree
    (defun handle-computer (tree)
      (let ((ratings (get-ratings (limit-tree-depth tree *ai-level*) (car tree)))) ; get ratings for next player
	...
	(if (zerop depth)
	    ...
	    (lazy-mapcar (lambda (move) 
			   (list (car move) ; return all moves
				 (limit-tree-dept (cadr move) (1- depth)))) ; all trees that result from each move
