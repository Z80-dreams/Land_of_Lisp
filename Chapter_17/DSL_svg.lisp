...
(defmacro svg (&body body)
  `(tag svg (xmlns "http://www.w3.org/2000/svg" ; for SVG
...
(defun cirle (center radius color) ; center is a cons cell (x-cordinate . y-cordinate)
...
(defun make-graph ()
  (with-open-file (*standard-output* "/home/masp/Cloud/Dropbox/Programming_projects/Land_of_Lisp/Chapter_17/graph.svg"
				     :direction :output
				     :if-exists :supersede)
    (svg (loop repeat 10 ; make 10 graphs
