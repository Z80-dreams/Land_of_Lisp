...
;;; This is the data we will convert to dotfile.
...
;;; and the input string, (exp, takes an object and makes into string).
...
;; Let's call it!
;;
;; (graph->png "wizzard.dot" *wizzard-nodes* *wizzard-edges*)
...
;; Let's call it!
;;
;; (ugraph->png "uwizzard.dot" *wizzard-nodes* *wizzard-edges*)
